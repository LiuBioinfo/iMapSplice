...
int main(int argc, char** argv)
{
	...
	juncHash_1->insertJuncFromJuncFile_chrNamePos_supportNum_anchorSize(juncHash_file_1_str, indexInfo);
	...
	juncHash_1->countTotalValidInvalidJuncNum_compareWithAnotherAlignInferJuncHash_juncWise_outputSupNumAnchorSize(
