...
clock_t read_file_begin, read_file_end, read_file_end2, read_file_end3, 
		...
		fixHeadTail_iniPeAlignInfo_begin, fixHeadTail_iniPeAlignInfo_end,
		fixHeadTail_iniPeAlignInfo_cost = 0,
		fixHeadTail_remapping_begin, fixHeadTail_remapping_end, 
		fixHeadTail_remapping_cost = 0,
		fixHeadTail_greedyMapping_begin, fixHeadTail_greedyMapping_end, 
		fixHeadTail_greedyMapping_cost = 0,
		fixHeadTail_remappingAndTargetMapping_begin, fixHeadTail_remappingAndTargetMapping_end,
		fixHeadTail_remappingAndTargetMapping_cost = 0,
		fixHeadTail_remappingAgain_begin, fixHeadTail_remappingAgain_end,
		fixHeadTail_remappingAgain_cost = 0,
		fixHeadTail_extend2end_finalStep_begin, fixHeadTail_extend2end_finalStep_end,
		fixHeadTail_extend2end_finalStep_cost = 0,
		fixHeadTail_extend2end_fixIndel_begin, fixHeadTail_extend2end_fixIndel_end,
		fixHeadTail_extend2end_fixIndel_cost = 0,		

		fixHeadTail_generatePeAlignInfo_begin, fixHeadTail_generatePeAlignInfo_end,
		fixHeadTail_generatePeAlignInfo_cost = 0,
		fixHeadTail_freePeAlignInfo_begin, fixHeadTail_freePeAlignInfo_end,
		fixHeadTail_freePeAlignInfo_cost = 0,

		fixHeadTail_overallRunning_begin, fixHeadTail_overallRunning_end,
		fixHeadTail_overallRunning_cost = 0; 
...
int main(int argc, char**argv)
{
	...
	bool Skip_phase2_bool = true;
	bool Run_for_Alu_project = true;
	...
	int normalRecordNum_1stMapping = 5000;//00;
	int normalRecordNum_fixOneEndUnmapped = 5000;//00;
	int normalRecordNum_fixHeadTail = 5000;//00;
	...
	#endif
	//////////////////////////////////////////////////
	cout << "start to initaite headerSectionInfo" << endl;
	HeaderSection_Info* headerSectionInfo;
	if(Run_for_Alu_project)
		headerSectionInfo = new HeaderSection_Info();
	else
		headerSectionInfo = new HeaderSection_Info(indexInfo);	
		...
		; tmpTurn++)
	{
		...
		for(int tmpOpenMP = 0; tmpOpenMP < realRecordNum; tmpOpenMP++)
		{
			...
			fixPhase1Info.fixPhase1_segInfo(
				...
				readInfo, repeatRegionInfoVec[threadNO], 
				checkQualSeqForReadSegSeq, 
				SE_or_PE_bool);

			// SegmentMatchComment_Info tmpSegmentMatchCommentInfo;
			// fixPhase1Info.fixPhase1_generateSegmentMatchCommentInfo(tmpSegmentMatchCommentInfo);
			// int multiMapSeg_maxLength = tmpSegmentMatchCommentInfo.return_multiMapSeg_maxLength_length();
			
			//fixPhase1Info.initiateGroupSegInfo();
			...
			// fixPhase1Info.fixPhase1_pathInfo_withGroupSegInfo(indexInfo, readInfo,
			// 	annotation_provided_bool, Do_annotation_only_bool, annotationInfo, 
			// 	MAX_SPLICE_DISTANCE_PHASE1);


			#ifdef MAP_INFO
			cout << "getPossiPathInfo_Nor1: " << endl;
			fixPhase1Info.coutPossiPathStr_Nor1();
			cout << "getPossiPathInfo_Rcm1: " << endl;
			fixPhase1Info.coutPossiPathStr_Rcm1();
			#endif
			...
			fixPhase1Info.fixPhase1_gapInfo(readInfo, indexInfo, Do_cirRNA, 
				Do_extendHeadTail_phase1, annotation_provided_bool, 
				Do_annotation_only_bool, annotationInfo, SE_or_PE_bool);

			//fixPhase1Info.fixPhase1_gapInfo_withGroupSegInfo(indexInfo, readInfo, Do_extendHeadTail_phase1);
			...
			//fixPhase1Info.fixPhase1_initiatePeAlignInfo_withGroupSegInfo(indexInfo);
			...
			//fixPhase1Info.alignmentFilter_fixPhase1_SJpenalty_withGroupSegInfo(
			//	readInfo.returnReadSeqLength_1(), readInfo.returnReadSeqLength_2());
			...
			//fixPhase1Info.mergeSubGroupPeAlignInfo2targetPeAlignInfo_withGroupSegInfo(peAlignInfo);
			...
			//fixPhase1Info.freeMemory_groupSegInfo();
			fixPhase1Info.memoryFree();
			peAlignInfo.memoryFree();
			//peAlignInfo.setAllPointersNULL();
			#ifdef CAL_TIME
			freeMem_end = clock();
...
{	
		...
		for(tmpTurn = 0; /*tmpTurn < TurnNum*/; tmpTurn++)
		{
			...
			#ifdef CAL_TIME
			fixHeadTail_overallRunning_begin = clock();
			#endif
			...
			for(int tmpOpenMP = 0; tmpOpenMP < realRecordNum; tmpOpenMP++)
			{
				...
				#ifdef CAL_TIME
				fixHeadTail_iniPeAlignInfo_begin = clock();
				#endif
				...
				#ifdef CAL_TIME
				fixHeadTail_iniPeAlignInfo_end = clock();
				fixHeadTail_iniPeAlignInfo_cost = fixHeadTail_iniPeAlignInfo_cost 
					+ fixHeadTail_iniPeAlignInfo_end - fixHeadTail_iniPeAlignInfo_begin;
				fixHeadTail_remapping_begin = clock();	 
				#endif
				//cout << endl << "***********************************"
				//	<< endl << "readName_1: " << peReadInfo.returnReadName_1() << endl;
...
{				
				...
				#ifdef CAL_TIME
				fixHeadTail_remapping_end = clock();
				fixHeadTail_remapping_cost = fixHeadTail_remapping_cost 
					+ fixHeadTail_remapping_end - fixHeadTail_remapping_begin;
				fixHeadTail_greedyMapping_begin = clock();	 
				#endif
...
{			
				...
				#ifdef CAL_TIME
				fixHeadTail_greedyMapping_end = clock();
				fixHeadTail_greedyMapping_cost = fixHeadTail_greedyMapping_cost 
					+ fixHeadTail_greedyMapping_end - fixHeadTail_greedyMapping_begin;
				fixHeadTail_remappingAndTargetMapping_begin = clock();	 
				#endif
...
{				
				...
				#ifdef CAL_TIME
				fixHeadTail_remappingAndTargetMapping_end = clock();
				fixHeadTail_remappingAndTargetMapping_cost = fixHeadTail_remappingAndTargetMapping_cost 
					+ fixHeadTail_remappingAndTargetMapping_end - fixHeadTail_remappingAndTargetMapping_begin;
				fixHeadTail_remappingAgain_begin = clock();	 
				#endif
...
{				
				...
				#ifdef CAL_TIME
				fixHeadTail_remappingAgain_end = clock();
				fixHeadTail_remappingAgain_cost = fixHeadTail_remappingAgain_cost 
					+ fixHeadTail_remappingAgain_end - fixHeadTail_remappingAgain_begin;
				fixHeadTail_extend2end_finalStep_begin = clock();	 
				#endif
				...
				#ifdef CAL_TIME
				fixHeadTail_extend2end_finalStep_end = clock();
				fixHeadTail_extend2end_finalStep_cost = fixHeadTail_extend2end_finalStep_cost 
					+ fixHeadTail_extend2end_finalStep_end - fixHeadTail_extend2end_finalStep_begin;
				fixHeadTail_extend2end_fixIndel_begin = clock();	 
				#endif
				...
				#ifdef CAL_TIME
				fixHeadTail_extend2end_fixIndel_end = clock();
				fixHeadTail_extend2end_fixIndel_cost = fixHeadTail_extend2end_fixIndel_cost 
					+ fixHeadTail_extend2end_fixIndel_end - fixHeadTail_extend2end_fixIndel_begin;
				fixHeadTail_generatePeAlignInfo_begin = clock();	 
				#endif
				...
				#ifdef CAL_TIME
				fixHeadTail_generatePeAlignInfo_end = clock();
				fixHeadTail_generatePeAlignInfo_cost = fixHeadTail_generatePeAlignInfo_cost 
					+ fixHeadTail_generatePeAlignInfo_end - fixHeadTail_generatePeAlignInfo_begin;
				fixHeadTail_freePeAlignInfo_begin = clock();	 
				#endif
				...
				#ifdef CAL_TIME
				fixHeadTail_freePeAlignInfo_end = clock();
				fixHeadTail_freePeAlignInfo_cost = fixHeadTail_freePeAlignInfo_cost 
					+ fixHeadTail_freePeAlignInfo_end - fixHeadTail_freePeAlignInfo_begin;	 
				#endif				

			}

			#ifdef CAL_TIME
			fixHeadTail_overallRunning_end = clock();
			fixHeadTail_overallRunning_cost 
				= fixHeadTail_overallRunning_cost 
					+ fixHeadTail_overallRunning_end - fixHeadTail_overallRunning_begin;
			#endif
	...
	#ifdef CAL_TIME
	double fixHeadTail_overallRunning_time = (double)fixHeadTail_overallRunning_cost/CLOCKS_PER_SEC;
	double fixHeadTail_iniPeAlignInfo_time = (double)fixHeadTail_iniPeAlignInfo_cost/CLOCKS_PER_SEC;
	double fixHeadTail_remapping_time = (double)fixHeadTail_remapping_cost/CLOCKS_PER_SEC;
	double fixHeadTail_greedyMapping_time = (double)fixHeadTail_greedyMapping_cost/CLOCKS_PER_SEC;
	double fixHeadTail_remappingAndTargetMapping_time = (double)fixHeadTail_remappingAndTargetMapping_cost/CLOCKS_PER_SEC;
	double fixHeadTail_remappingAgain_time = (double)fixHeadTail_remappingAgain_cost/CLOCKS_PER_SEC;
	double fixHeadTail_extend2end_finalStep_time = (double)fixHeadTail_extend2end_finalStep_cost/CLOCKS_PER_SEC;
	double fixHeadTail_extend2end_fixIndel_time = (double)fixHeadTail_extend2end_fixIndel_cost/CLOCKS_PER_SEC;
	double fixHeadTail_generatePeAlignInfo_time = (double)fixHeadTail_generatePeAlignInfo_cost/CLOCKS_PER_SEC;
	double fixHeadTail_freePeAlignInfo_time = (double)fixHeadTail_freePeAlignInfo_cost/CLOCKS_PER_SEC;

	log_ofs << endl << "fixHeadTail_overallRunning_time  = " << fixHeadTail_overallRunning_time << endl;
	log_ofs << endl << "fixHeadTail_iniPeAlignInfo_time  = " << fixHeadTail_iniPeAlignInfo_time << endl;
	log_ofs << endl << "fixHeadTail_remapping_time  = " << fixHeadTail_remapping_time << endl;
	log_ofs << endl << "fixHeadTail_greedyMapping_time  = " << fixHeadTail_greedyMapping_time << endl;
	log_ofs << endl << "fixHeadTail_remappingAndTargetMapping_time  = " << fixHeadTail_remappingAndTargetMapping_time << endl;
	log_ofs << endl << "fixHeadTail_remappingAgain_time  = " << fixHeadTail_remappingAgain_time << endl;
	log_ofs << endl << "fixHeadTail_extend2end_finalStep_time  = " << fixHeadTail_extend2end_finalStep_time << endl;
	log_ofs << endl << "fixHeadTail_extend2end_fixIndel_time  = " << fixHeadTail_extend2end_fixIndel_time << endl;
	log_ofs << endl << "fixHeadTail_generatePeAlignInfo_time  = " << fixHeadTail_generatePeAlignInfo_time << endl;
	log_ofs << endl << "fixHeadTail_freePeAlignInfo_time  = " << fixHeadTail_freePeAlignInfo_time << endl;
	#endif
