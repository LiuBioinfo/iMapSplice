...
int main(int argc, char**argv)
{
	...
	local = localtime(&nowtime);
	cout << endl << "[" << asctime(local) << "...";
	cout << "end of running getAlignInferJuncFromSAMfile_chrNamePos_supportNum_anchorSize" << endl;
	log_ofs << endl << "[" << asctime(local) << "...";
	log_ofs << "end of running getAlignInferJuncFromSAMfile_chrNamePos_supportNum_anchorSize" << endl;
