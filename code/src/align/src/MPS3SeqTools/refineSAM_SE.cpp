...
int main(int argc, char** argv)
{
	if(argc != 5)
	{
		cout << "Executable <InputIndexInfo> <inputSAM> <outputFolder> <threadNum>" << endl;
		exit(1);
	}
	...
	alignInferJunctionHashInfo->insertJuncFromAlignmentFileVec_storeRefineSAMinfoWithLowSupSJ_filterMultiUnmap_SE(
	...
	alignInferJunctionHashInfo->correct_output_SAM_withLowSupportLowConfidenceSJ_SE(refineSAMvecInfo_SE, 
	...
	alignInferJunctionHashInfo->refineMultiAlignment_SE(multi_sam_file_ori, multi_final_sam_file,
